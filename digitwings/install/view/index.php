...
<html lang="en">
    <head>
        ...
        <title>Mingrow - Ultimate Project Manager & CRM Installation</title>
        ...
        <div class="install-box">
            ...
            <div class="card card-install">
                <div class="card-header text-center">                    
                    <h2> Mingrow - Ultimate Project Manager & CRM Installation</h2>
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="configuration-tab">
                            <form name="config-form" id="config-form" action="do_install.php" method="post">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="row">
                                                ...
                                                <div class=" col-md-9">
                                                    <input id="dbprefix" type="text" value="Mingrow_" name="dbprefix" class="form-control" placeholder="Table Prefix" maxlength="21" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="section clearfix">
                                    <p>3. Please enter your Licence Key.</p>
                                    <hr />
                                    <div>
                                        <div class="form-group clearfix">
                                            <div class="row">
                                                <label for="purchase_code" class=" col-md-3">Licence Key</label>
                                                <div class="col-md-9">
                                                    <input type="text" value=""  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="Ask Team Mingrow for Licence Key" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i data-feather="check-circle" height="2.5rem" width="2.5rem" stroke-width="3" class='status mr10'></i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed Mingrow - Ultimate Project Manager & CRM.</span>  
                                </div>
